                          ...
                          <v-row>
                              <v-col cols="12" md="12">
                                  <v-list-item three-line class="text-center mt-1">
                                      <v-list-item-content>
                                          <div>
                                              <v-icon :color="active ? '#704232' : 'black'">el-icon-money</v-icon>
                                          </div>
                                          <v-list-item-subtitle
                          ...
                          <v-row>
                              <v-col cols="12" md="12">
                                  <v-list-item three-line class="text-center mt-1">
                                      <v-list-item-content>
                                          <div>
                                              <v-icon :color="active ? '#704232' : 'black'">el-icon-bank-card</v-icon>
                                          </div>
                                          <v-list-item-subtitle
                          ...
                          <v-row>
                              <v-col cols="12" md="12">
                                  <v-list-item three-line class="text-center mt-1">
                                      <v-list-item-content>
                                          <div>
                                              <v-icon :color="active ? '#704232' : 'black'">el-icon-full-screen</v-icon>
                                          </div>
                                          <v-list-item-subtitle
