            ...
            <v-list-item three-line  class="text-center ">
              <v-list-item-content>
                ...
                <v-list-item-subtitle
                  :class="active ? 'brown--text' : 'black--text'" class=" caption mt-4">{{category.category_name}}</v-list-item-subtitle>
              </v-list-item-content>
            </v-list-item>
          </v-col>
        </v-row>
  ...
  <v-col cols="12" sm="6">
    <v-card flat class="rounded-lg mx-5">
      <v-list-item three-line>
        ...
        >
        <v-img :src="require(`~/assets/2.png`)"></v-img>
        </v-list-item-avatar>
        <v-list-item-content>
        ...
        <v-item v-slot="{ active, toggle }" >
          ...
          >
            <v-list-item class="text-center"> 
              <v-list-item-content><v-icon dark color="orange" > el-icon-hot-water</v-icon>
              </v-list-item-content>
            </v-list-item>
          </v-card>
        </v-item>
